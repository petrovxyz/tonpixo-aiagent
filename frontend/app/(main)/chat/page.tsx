                ...
                <div className="max-w-3xl mx-auto w-full px-4">
                    <div className="flex items-center gap-2 pointer-events-auto">
                        <button
                            ...
                            className="flex items-center justify-center w-16 h-16 bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-full text-black hover:bg-white/20 transition-all shadow-lg active:scale-95 inset-shadow-sm inset-shadow-white/30 mt-10"
                        >
